User.create!(email:"test@test.com", password: "asdfasdf", name: "regular user")
puts "1 user created"

User.create!(email:"admin@test.com", password: "asdfasdf", name: "admin user", roles: "site_admin")
